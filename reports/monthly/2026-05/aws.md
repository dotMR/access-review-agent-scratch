...
| :-- | :-- | :-- | :-- | :-- | :-- |
| Drift | Karl Dandleton | `write` access to aws | 'admin' (baseline for current role 'Asset Owner') | 2026-09-09 | [#16](https://github.com/dotMR/access-review-agent-scratch/issues/16) |
| Unapproved access | Mike Truk | `write` access to aws | A recorded approval (auto or Asset Owner) on file | 2026-09-09 | [#15](https://github.com/dotMR/access-review-agent-scratch/issues/15) |
